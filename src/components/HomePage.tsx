            ...
            <form onSubmit={handleSearch} className="max-w-2xl mx-auto relative px-4">
                <div className="relative bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm rounded-2xl shadow-xl border border-pink-200/50 dark:border-gray-700/50 transition-colors duration-300">
                  <div className="absolute inset-y-0 left-0 pl-6 flex items-center pointer-events-none">
                    <Search className="h-5 w-5 sm:h-6 sm:w-6 text-[var(--grad-from)] dark:text-[var(--grad-from)] transition-colors duration-300" />
                  </div>
                  <input
                    type="text"
                    value={query}
                            ...
                            <div className="flex items-start justify-between">
                                ...
                                <div className="flex items-center space-x-3 mt-1">
                                  ...
                                  <span
                                    className={`text-xs px-2 py-0.5 rounded-full font-medium ${
                                      isMovie
                                        ? "bg-pink-100 text-[var(--grad-from)] dark:bg-gray-800/30 dark:text-[var(--grad-from)]"
                              ...
                              <div className="flex-shrink-0 ml-3">
                                <div className="w-2 h-8 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                  <div
                                    className="bg-gradient-to-t from-[var(--grad-from)] to-[var(--grad-to)] rounded-full transition-all duration-300"
                                    style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 mobile-spacing">
        {loading ? (
          <div className="text-center py-16">
            <div className="w-16 h-16 bg-gradient-to-r from-[var(--grad-from)] to-[var(--grad-to)] rounded-full animate-spin flex items-center justify-center mb-4 shadow-lg mx-auto">
          ...
          <>
            ...
            <div className="mb-12">
              <h2 className="flex items-center mb-8 text-3xl font-bold text-gray-900 dark:text-white transition-colors duration-300">
                <TrendingUp className="w-8 h-8 mr-3 text-[var(--grad-from)]" />
                Trending Movies
              </h2>
                ...
                {trendingMovies.map((movie) => (
                  ...
                  >
                    ...
                    <div className="p-3 sm:p-4">
                      <h3 className="font-semibold text-gray-900 dark:text-white text-xs sm:text-sm mb-2 line-clamp-2 group-hover:text-[var(--grad-from)] dark:group-hover:text-[var(--grad-from)] transition-colors">
                        {movie.title}
                      </h3>
