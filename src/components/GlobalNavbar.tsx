        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative flex items-center h-16">
                  ...
                  <Link
                    ...
                    className={`flex items-center space-x-2 px-4 py-2 rounded-xl font-medium transition-all ${
                      isActive(item.path)
                        ...
                        : "text-gray-600 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700/50 hover:text-[var(--grad-from)] dark:hover:text-[var(--grad-from)]"
                    }`}
                  >
            ...
            <div className="hidden md:flex items-center ml-auto space-x-3 z-10">
              <Link
                to="/donate"
                className="p-2 rounded-lg text-[var(--grad-from)] hover:text-[var(--grad-to)] transition flex items-center"
                title="Donate"
              >
