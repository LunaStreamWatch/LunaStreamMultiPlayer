      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-center gap-3 flex-wrap sm:flex-nowrap">
              ...
              <div className="flex items-center space-x-2">
                <select
                  ...
                  className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-md rounded-xl border border-pink-200/50 dark:border-gray-600/30 text-gray-900 dark:text-gray-100 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200 appearance-none"
                >
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 bg-white/95 dark:bg-gray-800/95 backdrop-blur-md rounded-xl border border-pink-200/50 dark:border-gray-600/30 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200"
                />
              </div>
            </div>
          </div>
        ...
        {loading && (
          <div className="flex items-center justify-center py-20">
            <div className="w-12 h-12 bg-gradient-to-r from-[var(--grad-from)] to-[var(--grad-to)] rounded-full animate-spin flex items-center justify-center shadow-lg">
          ...
          <>
              ...
              <div>
                ...
                {filteredItems.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-20">
                    <div className="w-20 h-20 bg-gradient-to-r from-[var(--grad-from)] to-[var(--grad-to)] rounded-full flex items-center justify-center mb-6 shadow-xl">
                    ...
                    {!searchTerm && (
                      <Link
                        to="/"
                        className="flex items-center space-x-2 bg-gradient-to-r from-[var(--grad-from)] to-[var(--grad-to)] text-white px-6 py-3 rounded-xl font-semibold hover:from-pink-600 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl"
                      >
                      ...
                      return (
                        ...
                        >
                          <Link to={link} className="block">
                            ...
                            <div className="p-4">
                              <h3 className="font-semibold text-gray-900 dark:text-gray-100 text-sm mb-2 line-clamp-2 group-hover:text-[var(--grad-from)] dark:group-hover:text-[var(--grad-from)] transition-colors">
                                {title}
                              </h3>
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center space-x-1">
                                  ...
                                  <span className="text-xs text-[var(--grad-from)] dark:text-[var(--grad-from)] font-medium">Watch</span>
                                </div>
                              </div>
                            </div>
                          </Link>
                          ...
                          <Link to={link} className="block">
                            ...
                            <div className="p-4">
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center space-x-1">
                                  <Heart className="w-3 h-3 text-[var(--grad-from)] fill-current" />
                                  <span className="text-xs text-[var(--grad-from)] dark:text-[var(--grad-from)] font-medium">Favorite</span>
                                </div>
                              </div>
                            </div>
                          </Link>
            ...
            {activeTab === 'stats' && (
              <div className="space-y-8">
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                  <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-md rounded-2xl shadow-xl border border-pink-200/50 dark:border-gray-600/30 p-6 transition-colors duration-300">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4 flex items-center">
                      <BarChart3 className="w-5 h-5 mr-2 text-[var(--grad-from)]" />
                      Content Breakdown
                    </h3>
                ...
                {/* Quick Actions */}
                <div className="bg-gradient-to-r from-[var(--grad-from)] to-[var(--grad-to)] rounded-2xl p-8 text-white">
